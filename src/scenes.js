(function(Lyria) {
  Lyria.Scenes = Lyria.Scenes || {};
  
  require(['lyria/scene', 'lyria/template/engine'], function(Scene, TemplateEngine) {
    Lyria.Scenes["scene1"] = new Scene("scene1", function(scene) {
      this.localization = {
        "en": {
          "title": "This is "
        },
      ...
      this.template = TemplateEngine.compile(function(Handlebars, depth0, helpers, partials, data) {
        ...
        if ( stack1 = helpers.btnSwitchToNextScene) {
          stack1 = stack1.call(depth0, {
            hash: {},
            data: data
          });
        } else {
          stack1 = depth0.btnSwitchToNextScene;
          stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1;
        }
    ...
    Lyria.Scenes["scene2"] = new Scene("scene2", function(scene) {
      this.localization = {
        "en": {},
        "de": {}
      };
