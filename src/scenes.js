(function(Lyria) {
	...
	require(["lyria/scene", "lyria/template/engine"], function(Scene, TemplateEngine) {Lyria.Scenes["scene1"] = new Scene("scene1", function(scene) {this.localization = {
	"en": {
		"title": "This is "
	},
	"de": {
...
;});Lyria.Scenes["scene2"] = new Scene("scene2", function(scene) {this.localization = {
	"en": {},
	"de": {}
}
;this.template = TemplateEngine.compile(function (Handlebars,depth0,helpers,partials,data) {
