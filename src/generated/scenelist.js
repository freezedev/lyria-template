define("mygame/scenelist", ["lyria/scene", "lyria/template/engine"], function(Scene, TemplateEngine) {
	var sceneList = {};
	sceneList["scene1"] = new Scene("scene1", function(scene) {
		this.localization = {
	"en": {
		"title": "This is "
	},
...
helpers = helpers || Handlebars.helpers; data = data || {};
  ...
  return buffer;
		...
		var sceneFunc = (function(sender, localization) {
...
;
		if (typeof sceneFunc === "function") { sceneFunc = sceneFunc.apply(scene, scene); }		return sceneFunc;	});
	sceneList["scene2"] = new Scene("scene2", function(scene) {
		this.localization = {
	"en": {},
	"de": {}
}
